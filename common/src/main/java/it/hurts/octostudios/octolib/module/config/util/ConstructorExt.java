...
import it.hurts.octostudios.octolib.module.config.annotation.CfgConstructor;
import it.hurts.octostudios.octolib.module.config.cfgbuilder.*;
...
import static it.hurts.octostudios.octolib.module.config.cfgbuilder.CompoundEntry.COMPOUND_CFG_TAG;
import static it.hurts.octostudios.octolib.module.config.cfgbuilder.DeconstructedObjectEntry.DECONSTRUCTED_CFG_TAG;
