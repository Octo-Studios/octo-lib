...
public class CheckboxWidget extends AbstractEntryWidget<Boolean> {
    public CheckboxWidget(ShatterConfig config, FieldWidget parent, Boolean defaultValue, Supplier<Boolean> getter, Consumer<Boolean> setter) {
        super(config, parent, defaultValue, getter, setter, 0, 0, 16, 16);
    }
