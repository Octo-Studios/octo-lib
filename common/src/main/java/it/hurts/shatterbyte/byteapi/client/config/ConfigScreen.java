...
import it.hurts.shatterbyte.byteapi.client.config.widget.GenericObjectWidget;
import it.hurts.shatterbyte.byteapi.client.config.widget.IconButtonWidget;
import it.hurts.shatterbyte.byteapi.client.config.widget.ListWidget;
import it.hurts.shatterbyte.byteapi.client.config.widget.MapWidget;
import it.hurts.shatterbyte.byteapi.client.config.widget.ScrollableWidget;
import it.hurts.shatterbyte.byteapi.client.config.widget.TextAreaWidget;
...
public class ConfigScreen extends Screen {
    ...
    public static final Atlas ATLAS = new Atlas(Identifier.fromNamespaceAndPath(ByteAPI.MOD_ID, "textures/config/config_atlas.png"), 263, 76);
    public static final Identifier LOGO = Identifier.fromNamespaceAndPath(ByteAPI.MOD_ID, "textures/config/logo.png");
    ...
    public void onClose() {
        ...
        if (config != null) {
            config.save(ByteAPIServices.platform().getConfigDirectory());
        }
