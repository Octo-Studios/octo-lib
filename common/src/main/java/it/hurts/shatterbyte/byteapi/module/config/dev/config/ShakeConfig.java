package it.hurts.shatterbyte.byteapi.module.config.dev.config;

import it.hurts.shatterbyte.byteapi.ByteAPI;
import it.hurts.shatterbyte.byteapi.module.config.dev.config.data.FallShakeConfigData;
import it.hurts.shatterbyte.byteapi.module.config.dev.config.data.ShakeConfigData;
...
public class ShakeConfig extends ShatterConfig {
    ...
    public String getName() {
        return ByteAPI.MOD_ID + "/modules/shake";
    }
