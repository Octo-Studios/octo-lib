...
public class UIElements {
    ...
    public static final UISprite TOGGLE_ENABLED = new UISprite.Single(ConfigScreen.ATLAS, 24, 1, 14, 8);
    public static final UISprite TOGGLE_DISABLED = new UISprite.Single(ConfigScreen.ATLAS, 39, 1, 14, 8);
