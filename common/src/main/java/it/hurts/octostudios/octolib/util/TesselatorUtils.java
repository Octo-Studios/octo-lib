...
public class TesselatorUtils {
    ...
    public static void drawFullQuadWithColor(VertexConsumer tes, Matrix4f matrix4f, float pos1X, float pos1Y, float pos1Z, float pos2X,
        ...
        if (matrix4f != null) {
            tes.vertex(matrix4f, pos1X, pos1Y, pos1Z).color(color.getRed(), color.getGreen(), color.getBlue(), color.getAlpha()).endVertex();
            tes.vertex(matrix4f, pos2X, pos2Y, pos2Z).color(color.getRed(), color.getGreen(), color.getBlue(), color.getAlpha()).endVertex();
            tes.vertex(matrix4f, pos3X, pos3Y, pos3Z).color(color.getRed(), color.getGreen(), color.getBlue(), color.getAlpha()).endVertex();
            tes.vertex(matrix4f, pos4X, pos4Y, pos4Z).color(color.getRed(), color.getGreen(), color.getBlue(), color.getAlpha()).endVertex();
    ...
    public static void drawQuadGradient(VertexConsumer tes, Matrix4f matrix4f, float pos1X, float pos1Y, float pos1Z, float pos2X,
        ...
        if (matrix4f != null) {
            tes.vertex(matrix4f,  pos4X,  pos4Y,  pos4Z).color(color1.getRed(), color1.getGreen(), color1.getBlue(), color1.getAlpha()).endVertex();
            tes.vertex(matrix4f,  pos1X,  pos1Y,  pos1Z).color(color1.getRed(), color1.getGreen(), color1.getBlue(), color1.getAlpha()).endVertex();
            tes.vertex(matrix4f,  pos2X,  pos2Y,  pos2Z).color(color2.getRed(), color2.getGreen(), color2.getBlue(), color2.getAlpha()).endVertex();
            tes.vertex(matrix4f,  pos3X,  pos3Y,  pos3Z).color(color2.getRed(), color2.getGreen(), color2.getBlue(), color2.getAlpha()).endVertex();
        } else {
