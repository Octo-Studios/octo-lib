...
public class TestConfigScreen extends Screen {
    ...
    protected void init() {
        super.init();
        this.addRenderableWidget(new CheckboxWidget(20, 20, 10, 10, Component.empty(), ShatterLib.CONFIG.getTestBoolean()));
        this.addRenderableWidget(new CheckboxWidget(20, 32, 10, 10, Component.empty(), ShatterLib.CONFIG.getAnotherTestBoolean()));
    }
