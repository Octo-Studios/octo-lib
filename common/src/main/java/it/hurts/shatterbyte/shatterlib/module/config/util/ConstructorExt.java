...
import it.hurts.shatterbyte.shatterlib.module.config.annotation.CfgConstructor;
import it.hurts.shatterbyte.shatterlib.module.config.cfgbuilder.*;
...
import static it.hurts.shatterbyte.shatterlib.module.config.cfgbuilder.CompoundEntry.COMPOUND_CFG_TAG;
import static it.hurts.shatterbyte.shatterlib.module.config.cfgbuilder.DeconstructedObjectEntry.DECONSTRUCTED_CFG_TAG;
